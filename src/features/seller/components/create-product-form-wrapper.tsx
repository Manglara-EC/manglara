...
export function CreateProductFormWrapper({ organizations }: Props) {
        ...
        return (
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Elige la organización bajo la cual publicarás este producto
                    </CardDescription>
                </CardHeader>
                <CardContent>
    ...
    return (
        <div className="space-y-6">
            ...
            <CreateProductForm organizationId={selectedOrganizationId} />
        </div>
    );
}
